...
{{< figure src="/media/docs/grafana/panels-visualizations/business-text/d3-hexbin.png" class="border" alt="D3 hexbin chart displayed using the Business Text panel." >}}
