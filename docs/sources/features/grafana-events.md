...
For a complete list of events, refer to the [Grafana Crash Course](https://grafana.com/docs/plugins/marcusolsson-dynamictext-panel/<PLUGINS_VERSION>/eventbus/).
