...
> [Volkov Labs](https://github.com/volkovlabs/business-text) -
...
> changes, see the
> [Notices](https://github.com/grafana/business-text/blob/main/NOTICES.md).

The Business Text panel plugin allows you to construct a text visualization
template from the values of a dataset returned by a data source query.
...
You can install the Business Text panel from the
[Grafana Plugins catalog](https://grafana.com/grafana/plugins/marcusolsson-dynamictext-panel/)
or use the Grafana command line tool.
...
- Supports display of time global variables (`__to` and `__from`) as seconds,
  ISO timestamps, or formatted using the `dayjs` library.
